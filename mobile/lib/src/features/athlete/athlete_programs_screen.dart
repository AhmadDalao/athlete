...
import 'package:throughline_mobile/src/features/athlete/athlete_program_detail_screen.dart';
    ...
    return PremiumCard(
      ...
      child: InkWell(
        onTap: () => Navigator.of(context).push(
          MaterialPageRoute(
            builder: (_) => AthleteProgramDetailScreen(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Expanded(
                  child: StatusChip(assignment.text('status', 'active')),
                ),
                Text(
            ...
            LinearProgressIndicator(
              value: ((completion['percent'] as num?)?.toDouble() ?? 0) / 100,
              minHeight: 7,
