...
export default function InvitationIndex({ adminMode, filters, summary, invitations, coachOptions, statusOptions }: InvitationPageProps) {
    ...
    const applyFilters = (event: FormEvent<HTMLFormElement>) => {
        event.preventDefault();
        router.get(baseRoute, filterPayload, { preserveState: true, preserveScroll: true, replace: true });
    };

    useAutoFilter({ url: baseRoute, payload: filterPayload, only: ['filters', 'summary', 'invitations'] });
                ...
                <WorkspaceHero
                    ...
                    actions={
                        <>
                            ...
                            <Button asChild size="lg" variant="outline" className="rounded-full border-stone-300 bg-white">
                                <a href={route(adminMode ? 'admin.invitations.index' : 'roster.invitations.index', { ...filterPayload, export: 1 })}>
