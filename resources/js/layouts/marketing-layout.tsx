...
export default function MarketingLayout({ children, title, description }: MarketingLayoutProps) {
    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-[radial-gradient(circle_at_top,_#f7f1df_0,_#f1ead7_34%,_#ece2cb_64%,_#e8decb_100%)] text-stone-950">
                <div className="absolute inset-0 bg-[linear-gradient(rgba(120,91,35,0.08)_1px,transparent_1px),linear-gradient(90deg,rgba(120,91,35,0.08)_1px,transparent_1px)] bg-[size:48px_48px] opacity-40" />
                <div className="relative mx-auto flex min-h-screen w-full max-w-7xl flex-col px-6 py-6 lg:px-10">
                    <header className="flex items-center justify-between gap-6 border-b border-stone-900/10 pb-5">
