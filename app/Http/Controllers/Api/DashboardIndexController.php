...
class DashboardIndexController extends Controller
{
    ...
    public function __invoke(Request $request, MetricAnalyticsService $metricAnalytics, AthleteProgressAnalyticsService $progressAnalytics): JsonResponse
    {
        /** @var User $user */
    ...
    private function adminOverview(): array
    {
        ...
        return [
            ...
            'expiringMembershipWatchlist' => $activeMemberships
                ->sortBy(fn (Membership $membership) => $this->daysRemaining($membership) ?? 10000)
                ->take(5)
    ...
    private function coachOverview(User $coach): array
    {
        ...
        $roster = $coach->coachAssignments
            ...
            ->map(function ($assignment): array {
                ...
                } elseif (($this->daysRemaining($membership) ?? 9999) <= 7) {
                    $flags[] = 'Renewal soon';
                }
                ...
                return [
                    ...
                    'latestCheckIn' => $this->checkInPayload($latestCheckIn),
    ...
    private function currentProgramFor(User $athlete): ?TrainingProgram
    {
        return $athlete->trainingProgramsAsAthlete
            ...
            }) * 10000000000 - ($program->start_date?->timestamp ?? 0))
            ->first();
    }
