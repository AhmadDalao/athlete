...
class PermissionCatalog
{
    ...
    {
        return match ($role) {
            'admin' => ['admin.access', 'admin.audit', 'admin.contacts', 'organizations.manage', 'users.manage', 'coaches.manage', 'athletes.manage', 'invitations.manage', 'roster.assign', 'reports.view', 'notifications.read'],
